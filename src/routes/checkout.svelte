...
<section>
  ...
  <div class:hidden={!$cartStore.length || !showOrderInfo}>
    ...
    <p>*Prosím nezadávejte skutečná data, tato stránka je pouze zkušební</p><br>Pro objednávku do Německa zadávejte prosím adresu výdejního místa Hermès.com<br>
    <Order
      cart={$cartStore}
